 ...
 * Slug: patterns-magazine/primary-sidebar
 * Categories: posts
...
<div class="wp-block-group">
	<!-- wp:pattern {"slug":"patterns-magazine/search-form"} /-->
	<!-- wp:pattern {"slug":"patterns-magazine/latest-posts"} /-->
	<!-- wp:pattern {"slug":"patterns-magazine/latest-comments"} /-->
</div>
<!-- /wp:group -->
